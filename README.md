...
# Dipassio Smart Account (Smart Contract Wallet) Overview

Dipassio Smart Account is a smart contract wallet that builds on core concepts of Gnosis / Argent safes and implements an interface to support calls from [account abstraction](https://eips.ethereum.org/EIPS/eip-4337) Entry Point contract. We took all the good parts of existing smart contract wallets. 
